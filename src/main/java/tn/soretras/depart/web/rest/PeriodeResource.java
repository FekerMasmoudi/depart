...
/**
 * REST controller for managing {@link tn.soretras.depart.domain.Periode}.
 */
@RestController
@RequestMapping("/api")
public class PeriodeResource {
    ...
    public ResponseEntity<PeriodeDTO> createPeriode(@RequestBody PeriodeDTO periodeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<PeriodeDTO> updatePeriode(
        ...
        @RequestBody PeriodeDTO periodeDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, periodeDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PeriodeDTO> partialUpdatePeriode(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, periodeDTO.getId())
        );
    }
