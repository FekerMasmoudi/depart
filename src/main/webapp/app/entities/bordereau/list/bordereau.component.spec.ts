...
describe('Bordereau Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bordereau', component: BordereauComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bordereaus?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to bordereauService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getBordereauIdentifier');
