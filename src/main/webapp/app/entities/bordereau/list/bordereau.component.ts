...
import { EntityArrayResponseType, BordereauService } from '../service/bordereau.service';
...
export class BordereauComponent implements OnInit {
  ...
  trackId = (_index: number, item: IBordereau): string => this.bordereauService.getBordereauIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.bordereaus = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IBordereau[] | null): IBordereau[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.bordereauService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
