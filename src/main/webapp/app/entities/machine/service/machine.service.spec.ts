...
const requireRestSample: RestMachine = {
  ...
  datfab: sampleWithRequiredData.datfab?.format(DATE_FORMAT),
  datacq: sampleWithRequiredData.datacq?.format(DATE_FORMAT),
  datmes: sampleWithRequiredData.datmes?.format(DATE_FORMAT),
  datact: sampleWithRequiredData.datact?.format(DATE_FORMAT),
};
