...
describe('Periode Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'periode', component: PeriodeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.periodes?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to periodeService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getPeriodeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPeriodeIdentifier).toHaveBeenCalledWith(entity);
